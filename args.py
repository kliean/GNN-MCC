...
parser.add_argument('--predict_pairs', type=bool, default=False, help='')
parser.add_argument('--mode', type=str, default='image', help='text or image')
...
parser.add_argument('--gnn_type', type=str, default='gat', help='gat,sage,gcn')
parser.add_argument('--temperature', type=float, default=1, help='temperature')
parser.add_argument('--smoothing', type=float, default=0, help='')

parser.add_argument('--batch_size', dest='batch_size', default=1000, type=int, help='1000 if gat')
